...
function AChats() {
  const { backendurl, assistantToken } = useContext(AssistantContext);
    ...
    {sortedConversations.map((conversation) => (
      ...
      >
        ...
        <div className="flex items-center justify-center   ">
          <Link to={`/assistant-chatroom/id/${conversation.participants[0]._id}`}> <button  className="bg-green-500 text-white w-[70px] px-4 py-2 rounded-lg text-sm hover:bg-green-600 transition-all duration-300 ease-in-out flex justify-center items-center">
           View</button> </Link> 
