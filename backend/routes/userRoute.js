...
import {registerUser,loginUser,cancelapp,updateUserP,getProfile,bookApp, sendAppList} from '../controllers/userControler.js'
...
userRouter.post('/update-profile',uplaoad.single("image"),authUser,updateUserP)
